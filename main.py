...
bot = Client("bot",
             bot_token= "6453643657:AAGQY04x4QZMYWLymHtTz6T1uWiKzofxvHY",
             api_id= 23282918,
             api_hash= "ccf2a6664d1ae478b8c556000f616120")
auth_users = [5911618569, -1002079872230]
...
async def txt_handler(bot: Client, m: Message):
    ...
    await editable.edit("**Enter resolution 360,480,720**")
    ...
    input3: Message = await bot.listen(editable.chat.id,filters.user(m.from_user.id))
